...
(function(global) {
  ...
  var canvas, gl, program, program2, pos_cahaya = [0.0, 0.0, 0.0], xPlus = 0.01, yPlus = 0.02, zPlus = 0.03;
  ...
  function main() {
    ...
    function cube(){
      ...
      var kecerahan = 0.1; //tingkat kecerahan

      var lightPosition = [0 + pos_cahaya[0] ,0 + pos_cahaya[1] ,0 + pos_cahaya[2]];
      var ambientColor = glMatrix.vec3.fromValues(0.17, 0.40, 0.25); //nrp
      gl.uniform3fv(lightColorLoc, lightColor);
      gl.uniform3fv(lightPositionLoc, lightPosition);
      gl.uniform3fv(ambientColorLoc, ambientColor);
      gl.uniform1f(shine, kecerahan);
    ...
    function triangle(){
      gl.useProgram(program);
            ...
            if (pos_cahaya[0]  < -0.5 || pos_cahaya[0] > 0.5) {
                xPlus*=-1;
            }

            pos_cahaya[0] += xPlus;
            var middle_point = -0.3 + pos_cahaya[0];
            var tengah = gl.getUniformLocation(program, 'tengah');
            
            gl.uniform1f(tengah, middle_point);

            if (pos_cahaya[1] < -0.5 || pos_cahaya[1] > 0.5) {
                yPlus*=-1;
            }

            pos_cahaya[1] += yPlus;

            if (pos_cahaya[2] < -0.5 || pos_cahaya[2] > 0.5) {
                zPlus*=-1;
            }

            pos_cahaya[2] += zPlus;
            
            gl.uniform3fv(gerak, pos_cahaya);
      ...
      var kecerahan = 0.01; //tingkat shininess
      ...
      var mm = glMatrix.mat4.create();
      glMatrix.mat4.translate(mm, mm, [0.0, 0.0,-0.2]);
      glMatrix.mat4.translate(mm, mm, pos_cahaya);
    ...
    function texturePack(){      
      ...
      function initTexture(callback, args) {
        var imageSource = 'images/hehe.png';
